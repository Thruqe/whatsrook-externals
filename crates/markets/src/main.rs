...
fn normalize_pair(input: &str) -> String {
    let s = input
        ...
        .replace(' ', "");
    match s.as_str() {
        "GOLD" | "XAUUSD" | "XAU/USD" | "GOLD/USD" | "XAU" => "Gold/USD".to_string(),
        "SILVER" | "XAGUSD" | "XAG/USD" | "SILVER/USD" | "XAG" => "Silver/USD".to_string(),
        "OIL" | "WTI" | "WTI/USD" | "CRUDE" | "USOIL" => "WTI/USD".to_string(),
        "BRENT" | "BRENT/USD" | "UKOIL" => "Brent/USD".to_string(),
        "NATGAS" | "NATGAS/USD" | "GAS" => "NatGas/USD".to_string(),
        "HEATOIL" | "HEATOIL/USD" => "HeatOil/USD".to_string(),
        "DOW" | "DOW/USD" | "DOWJONES" | "US30" | "DJIA" | "WS30" => "Dow/USD".to_string(),
        "SPX" | "SPX/USD" | "SP500" | "US500" | "S&P500" | "SPX500" => "SPX/USD".to_string(),
        "NDX" | "NDX/USD" | "NASDAQ" | "US100" | "NAS100" | "USTECH" => "NDX/USD".to_string(),
        "NIKKEI" | "NIKKEI225" | "NIKKEI225/USD" | "JP225" | "JPN225" => {
            "Nikkei225/USD".to_string()
        }
        "DAX" | "DAX/USD" | "GER30" | "DE30" | "GER40" | "DE40" => "DAX/USD".to_string(),
        "FTSE" | "FTSE100" | "FTSE100/USD" | "UK100" => "FTSE100/USD".to_string(),
        "STOXX50" | "STOXX50/USD" | "EU50" => "STOXX50/USD".to_string(),
        "US2000" | "US2000/USD" | "RUSSELL2000" | "RUSSELL" => "US2000/USD".to_string(),
        "VIX" | "VIX/USD" => "VIX/USD".to_string(),
        "DXY" | "DXY/USD" | "USDX" => "DXY/USD".to_string(),
        "CAC" | "CAC40" | "CAC/USD" | "FRA40" => "CAC/USD".to_string(),
        "EURUSD" | "EUR/USD" => "EUR/USD".to_string(),
        "GBPUSD" | "GBP/USD" => "GBP/USD".to_string(),
        "USDJPY" | "USD/JPY" => "USD/JPY".to_string(),
        "USDCHF" | "USD/CHF" => "USD/CHF".to_string(),
        "USDCAD" | "USD/CAD" => "USD/CAD".to_string(),
        "AUDUSD" | "AUD/USD" => "AUD/USD".to_string(),
        "NZDUSD" | "NZD/USD" => "NZD/USD".to_string(),
        "BTCUSD" | "BTC/USD" | "BTC" | "BITCOIN" => "BTC/USD".to_string(),
        "ETHUSD" | "ETH/USD" | "ETH" | "ETHEREUM" => "ETH/USD".to_string(),
        "DOGEUSD" | "DOGE/USD" | "DOGE" => "DOGE/USD".to_string(),
        _ => {
            if s.contains('/') {
                s
            } else if s.len() == 6 {
